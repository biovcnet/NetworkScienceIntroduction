...
We have to transpose, and the time names have to start with a letter
```{r}
eLSAMtx <- t(spotClrMtx)
colnames(eLSAMtx) <-  str_c("t",colnames(eLSAMtx), sep = "_" )
```
...
cat("# \t ", file = "SPOT/spotClrMtx.tsv")
thout <- write.table(eLSAMtx, "SPOT/spotClrMtx.tsv", quote = FALSE, sep = "\t", append = TRUE)
